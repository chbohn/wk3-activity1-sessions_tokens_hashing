package wk3.activity1.sessions_tokens_hashing;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.dataformat.yaml.YAMLFactory;
import wk3.activity1.sessions_tokens_hashing.configs.Configs;
import wk3.activity1.sessions_tokens_hashing.logger.ServiceLogger;
import wk3.activity1.sessions_tokens_hashing.models.ConfigsModel;
...
public class ExampleService {
    public static wk3.activity1.sessions_tokens_hashing.ExampleService exampleService;
    ...
    private void initHTTPServer() {
        ...
        try {
            ...
            ResourceConfig rc = new ResourceConfig().packages("wk3.activity1.sessions_tokens_hashing.resources");
